...
function Sliders() {
    ...
    const Carosel = [
        {
            img: Img,
            Heding : "Wizkid made in lagos tour",
    ...
    <section className='mt-5 container mx-auto'>
            ...
            <h1 className='text-xl sm:text-2xl md:text-3xl font-bold text-center'>See How People are Chilling On Chillsbay</h1>

        <div className='relative m-20 flex mx-auto justify-center items-center'>
